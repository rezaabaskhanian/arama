...
type Repository interface {
	...
	// FindExerciseByID(ctx context.Context, id uuid.UUID) (*Exercise, error)
	// FindExercisesByTraumaType(ctx context.Context, traumaType assessmentvalueobject.TraumaType) ([]*Exercise, error)
	...
	SaveUserExercise(ctx context.Context, userExerciseID string) (domain.UserExercise, error)
	...
	// CountUserCompletedExercises(ctx context.Context, userID uservalueobject.UserID) (int, error)
	// IsExerciseCompletedByUser(ctx context.Context, userID uservalueobject.UserID, exerciseID uuid.UUID) (bool, error)
